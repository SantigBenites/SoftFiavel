// Dafny program temp.dfy compiled into C#
...
// Command Line Options: /home/santig/Documents/VSCode/SoftFiavel/temp.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:SoftFiavel/bin/temp
// temp.dfy

method digits(n: nat) returns (d: nat)
  decreases n
{
  var x := n;
  var k := 0;
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger digits(BigInteger n)
    {
      ...
      while ((_0_x) >= (new BigInteger(10))) {
        _0_x = Dafny.Helpers.EuclideanDivision(_0_x, new BigInteger(10));
        _1_k = (_1_k) + (BigInteger.One);
      }
      d = (_1_k) + (BigInteger.One);
      return d;
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> __noArgsParameter)
    {
      BigInteger _2_a;
      BigInteger _out0;
      _out0 = __default.digits(BigInteger.Zero);
      _2_a = _out0;
